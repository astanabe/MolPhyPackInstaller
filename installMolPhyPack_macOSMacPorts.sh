...
mv jdk8u345-b01-jre/Contents/Home/* $PREFIX/share/molphypack/ || sudo mv jdk8u345-b01-jre/Contents/Home/* $PREFIX/share/molphypack/ || exit $?
rm -rf jdk8u345-b01-jre OpenJDK8U-jre_x64_mac_hotspot_8u282b08.tar.gz || exit $?
touch .java || exit $?
fi
