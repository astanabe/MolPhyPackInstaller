sudo -E port install gmake wget unzip gnutar xz zlib bzip2 autoconf automake coreutils ncurses readline openmpi || exit $?
...
mv jdk-11.0.20.1+1-jre/Contents/Home/* $PREFIX/share/molphypack/ || sudo mv jdk-11.0.20.1+1-jre/Contents/Home/* $PREFIX/share/molphypack/ || exit $?
...
gnutar -xzf mafft-7.505-without-extensions-src.tgz || exit $?
...
gnutar -xzf primer3-2.6.1.tar.gz || exit $?
...
gnutar -xzf RAxML-8.2.12.tar.gz || exit $?
...
gnutar -xzf ../Tracer_v1.7.2.tgz || exit $?
cd lib || exit $?
